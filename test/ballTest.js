 define(['ball'], function(Ball) {
  ...
  TestCase("test ball", {
    ...
    "test Ball constructor": function () {
      ...
      var balls = new Ball();
      assertTrue(balls instanceof Ball);
    },
  
    "test move the ball": function() {
      var ball = new Ball({ xPos: 5, yPos: 5, xVel: 1, yVel: 1, radius: 1, airFriction: 0 });
    ...
    "test bounce the ball": function() {
      var ball = new Ball({ xPos: 9, yPos: 5, xVel: 2, yVel: 0, radius: 1, airFriction: 0 });
